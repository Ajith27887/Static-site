	    ...
	    <div className="relative flex h-16 items-center justify-between">
	      ...
	      <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
	        <div className="flex shrink-0 items-center">
	          <img src="https://cdn-ilaokij.nitrocdn.com/fVRHcAtMvVjUZYHHNqUPXddmzZLqoodC/assets/images/optimized/rev-090f566/usercontent.one/wp/www.badmintonspeak.com/wp-content/uploads/2024/06/62c3290402673a6927ac37e1ecf5921a.shuttlecock-image-696x696.jpg" alt="Your Company" className="h-12 w-auto" />
	        </div>
